...
$("#modal-button").on('click', function(event) {
    ...
    console.log("modal button clicked, create/login");
});

// function run after DOM loads
$(document).ready(function () {

    // loads the emoji modal
    ...
    // enables the create account button in login-modal
...
// this should only be called when eatOut is loaded
